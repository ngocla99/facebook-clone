export const FriendEmpty = (props) => {
  return (
    <svg viewBox="0 0 112 112" width="112" height="112" {...props}>
      <defs>
        <clipPath id="a">
      ...
      <path
        fill="#a4a7ab"
        d="M18.87 55.28h28.3a7 7 0 0 1 7 7v37.36H11.92V62.23a7 7 0 0 1 6.95-6.95z"
      ></path>
      <path
        fill="#64676b"
        d="M68.63 68.28h5.06A26.12 26.12 0 0 1 99.8 94.4v5.25H42.51V94.4a26.12 26.12 0 0 1 26.12-26.12z"
      ></path>
