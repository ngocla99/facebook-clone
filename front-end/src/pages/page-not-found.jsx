      ...
      <div className="relative flex min-h-screen flex-col">
        ...
        <main className="grid flex-1 place-items-center bg-background-comment">
          <div className="flex w-[500px] flex-col items-center justify-center p-6 text-center">
            ...
            <Button
              className="mt-6 h-10 w-[212px] text-lg font-semibold"
            ...
            <Button
              variant="ghost"
              className="mt-2 h-5 text-lg font-semibold text-[#0064d1] hover:bg-transparent hover:text-[#0064d1] hover:underline hover:underline-offset-1"
              disabled
            >
              Visit Help Center
            </Button>
